...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyBfVfTrfjdlvAufGkm2JHkQC0MnCjtwN5A'
        ...
        mydb = client['guvi_database']

        # create a collection
        collection = mydb['guvi_collection']
...
with col2:
    ...
    if question_tosql == '1. What are the names of all the videos and their corresponding channels?':
        cursor.execute(
            "SELECT channel.Channel_Name, video.Video_Name FROM channel JOIN playlist JOIN video ON channel.Channel_Id = playlist.Channel_Id ;")
